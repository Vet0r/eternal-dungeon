...
class _ForgotMyPasswordState extends State<ForgotMyPassword> {
    ...
    return Padding(
      ...
      child: RichText(
        ...
        text: TextSpan(
          ...
          text:
              "Digite seu email a baixo e iremos te enviar um email para recuperar sua senha. Não esqueça de checar o SPAM",
        ),
      ),
    );
  }
  ...
  sendButton(double width, double height, TextEditingController? email,
